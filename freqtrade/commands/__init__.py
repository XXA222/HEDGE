...
def start_hedge_db(args):
    """Lazily import the optional Hedge database administration command."""
    from freqtrade.commands.hedge_db_commands import start_hedge_db as command

    return command(args)


def start_hedge_backtesting(args):
    """Lazily import the Hedge historical runner."""
    from freqtrade.commands.hedge_runtime_commands import (
        start_hedge_backtesting as command,
    )

    return command(args)


def start_hedge_paper(args):
    """Lazily import the durable Hedge Paper runner."""
    from freqtrade.commands.hedge_runtime_commands import start_hedge_paper as command
