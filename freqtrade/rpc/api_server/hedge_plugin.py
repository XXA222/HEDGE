...
def _register_event_publishers(app: FastAPI, *, rpc: object | None, event_hub: object) -> None:
    ...
    try:
        ...
        event_loop = None
    hub_callback = HedgeEventHubPublisher(event_hub, loop=event_loop).publish
...
def _register_dashboard_routes(
    ...
    *,
    ...
    account_id = str(cast(dict[str, object], hedge_config).get("account_id", "hedge-main"))
...
def _register_hedge_research_routes(
    *,
    ...
    app.router.add_event_handler("shutdown", stop_research_executor)
    app.include_router(
        create_hedge_research_router(
