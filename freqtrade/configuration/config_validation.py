...
from functools import wraps as _hedge_wraps
...
from freqtrade.hedge.config import normalize_hedge_config, validate_hedge_config
...
def _validate_config_consistency_base(conf: dict[str, Any], *, preliminary: bool = False) -> None:
    """
...
_upstream_validate_config_consistency = _validate_config_consistency_base


@_hedge_wraps(_upstream_validate_config_consistency)
def validate_config_consistency(conf, *args, **kwargs):
    normalize_hedge_config(conf)
    _upstream_validate_config_consistency(conf, *args, **kwargs)
    validate_hedge_config(conf)
