...
def _normalize_symbol(value: object) -> str:
    ...
    if settle and (not settle.isascii() or not settle.isalnum() or not normalized.endswith(settle)):
...
def build_client_order_id(
    *,
    ...
    normalized_key = _clean_text(idempotency_key, field_name="idempotency_key", max_length=256)
