...
from freqtrade.hedge.errors import is_definitive_error
...
class UnknownOrderSupervisor:
    ...
    def attempt(self, client_order_id: str) -> UnknownRecoveryRecord:
        ...
        try:
            ...
            definitive_failure = is_definitive_error(exc)
        else:
        ...
        with self._lock:
            ...
            if definitive_failure:
                manual_review = replace(
                    ...
                    next_retry_at=None,
                    last_message=message or "UNKNOWN_RECOVERY_DEFINITIVE_FAILURE",
                )
                self._records[client_order_id] = manual_review
