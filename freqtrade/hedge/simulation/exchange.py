...
from freqtrade.hedge.contracts.events import (
    BarEvent as ContractBarEvent,
)
from freqtrade.hedge.contracts.events import (
    FundingEvent as ContractFundingEvent,
)
from freqtrade.hedge.contracts.events import (
    SignalEvent as ContractSignalEvent,
)
...
SignalEvent = ContractSignalEvent
BarEvent = ContractBarEvent
FundingEvent = ContractFundingEvent
