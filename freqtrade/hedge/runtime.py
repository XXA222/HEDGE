...
class HedgeRuntime:
    ...
    def _normalize_checks(
        ...
        for raw_name, value in checks.items():
            ...
            if not isinstance(value, bool):
                raise ValueError(  # noqa: TRY004 - readiness projection contract
                    "readiness check values must be booleans"
                )
            name = raw_name.strip()
    ...
    def publish(
        ...
        *,
        ...
        if not isinstance(stale, bool):
            raise ValueError(  # noqa: TRY004 - runtime projection contract
    ...
    def _empty_source_view(self, source: HedgeProjectionSource) -> HedgeSourceView:
        ...
        return HedgeSourceView(
            ...
            stream_state=("NOT_APPLICABLE" if source is HedgeProjectionSource.PAPER else "UNKNOWN"),
