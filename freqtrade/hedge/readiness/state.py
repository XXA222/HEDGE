...
class ReadinessCheckResult:
    ...
    def __post_init__(self) -> None:
        ...
        if not isinstance(self.passed, bool):
            raise ValueError(  # noqa: TRY004 - readiness state contract
                "Readiness check passed must be a boolean."
            )
...
class ReadinessReport:
    ...
    def __post_init__(self) -> None:
        ...
        if isinstance(self.evaluated_at_ms, bool) or not isinstance(self.evaluated_at_ms, int):
            raise ValueError(  # noqa: TRY004 - readiness state contract
                "evaluated_at_ms must be an integer."
            )
        ...
        if not isinstance(self.emergency_reduce_only_allowed, bool):
            raise ValueError(  # noqa: TRY004 - readiness state contract
                "emergency_reduce_only_allowed must be a boolean."
            )
