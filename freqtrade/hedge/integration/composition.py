...
class RuntimeReadinessExecutionAdapter:
    ...
    def evaluate(self, position_key: PositionKey) -> ReadinessDecision:
        ...
        risk_key = RiskPositionKey(
            ...
            position_side=PositionSide(position_key.position_side.value),
        ...
        *,
        ...
        return cast(
            ...
            self._locks.lock(
                ...
                position_side=PositionSide(resolved.position_side.value),
...
def _build_readonly_coordinator(
    *,
    ...
    if not str(exchange.get("key", "")).strip() or not str(exchange.get("secret", "")).strip():
        raise OperationalException(
...
def _build_paper_graph(
    *,
    ...
    typed_session_factory = cast(SessionFactory, session_factory)
    leverage = _decimal(
    ...
    limits = RiskLimits(
        ...
        min_liquidation_buffer_ratio=_decimal(hedge.get("min_liquidation_buffer_ratio"), "0.05"),
        max_gross_notional=(
            None
    ...
    commit_store = SqlRiskApprovalCommitStore(cast(Any, session_factory))
