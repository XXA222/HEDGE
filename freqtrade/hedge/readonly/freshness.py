...
class UserStreamFreshness:
    ...
    def _calibration_missing(self, health: StreamHealth) -> bool:
        return self.policy.reconnect_calibration_required and health.last_calibration_at is None
    ...
    def assess(self, health: StreamHealth, *, now: datetime) -> FreshnessAssessment:
        ...
        calibration_age = None if raw_calibration_age is None else max(0.0, raw_calibration_age)
