...
class HedgeRLActionMask:
    ...
    def decide(
        ...
        *,
        ...
        size = min(
            max(finite_decimal(magnitude, field_name="magnitude"), ZERO), self.limits.max_step_ratio
        )
    ...
    def transition(
        ...
        *,
        ...
        facts = HedgeRLTransitionFacts(
            ...
            core_damage_ratio=finite_decimal(core_damage, field_name="core_damage")
            / self.initial_equity,
...
class VectorHedgeRLEnvironment:
    ...
    def __init__(self, initial_equities: Sequence[object]) -> None:
        ...
        self.ledgers = [
            HedgeRLEpisodeLedger(finite_decimal(item, field_name="initial_equity"))
            for item in initial_equities
        ]
