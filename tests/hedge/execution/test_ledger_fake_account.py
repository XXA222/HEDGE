...
def test_fake_reduce_cannot_reverse_position() -> None:
    ...
    submitted = runtime.engine.submit(intent(action=IntentAction.REDUCE, key="reduce", qty="1"))
...
def test_reduce_fill_realizes_pnl_without_crossing_zero() -> None:
    ...
    reduced = runtime.engine.submit(intent(action=IntentAction.REDUCE, key="reduce", qty="0.25"))
