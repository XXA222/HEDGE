    ...
    return {
        "hedge": {
            ...
            "optimization": {
                ...
                "sampler": "grid",
                "trials": 3,
                # This module tests engine scoring/persistence semantics, not
                # process-pool behavior. Keep evaluator side effects in-process
                # on every OS; test_parallel.py owns the parallel contract.
                "workers": 1,
