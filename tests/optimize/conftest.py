    ...
    return pd.DataFrame(
        {
            ...
            "open_date": [
                datetime(2019, 1, 1, 9, 15, 0, tzinfo=UTC),
                datetime(2019, 1, 2, 8, 55, 0, tzinfo=UTC),
                datetime(2019, 1, 3, 9, 15, 0, tzinfo=UTC),
                datetime(2019, 1, 4, 9, 15, 0, tzinfo=UTC),
            ],
            "close_date": [
                datetime(2019, 1, 1, 9, 25, 0, tzinfo=UTC),
                datetime(2019, 1, 2, 9, 25, 0, tzinfo=UTC),
                datetime(2019, 1, 3, 9, 25, 0, tzinfo=UTC),
                datetime(2019, 1, 4, 9, 25, 0, tzinfo=UTC),
            ],
        }
    )
